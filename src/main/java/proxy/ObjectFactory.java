...
public class ObjectFactory {
    ...
    private static final QName _Conversion_QNAME = new QName("http://ws.hd.saifdine.ma/", "conversion");
    private static final QName _ConversionResponse_QNAME = new QName("http://ws.hd.saifdine.ma/", "conversionResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.hd.saifdine.ma/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.hd.saifdine.ma/", "getCompteResponse");
    private static final QName _GetComptes_QNAME = new QName("http://ws.hd.saifdine.ma/", "getComptes");
    private static final QName _GetComptesResponse_QNAME = new QName("http://ws.hd.saifdine.ma/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.hd.saifdine.ma/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.hd.saifdine.ma/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.hd.saifdine.ma/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.hd.saifdine.ma/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.hd.saifdine.ma/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.hd.saifdine.ma/", name = "getComptesResponse")
